...
import certNodeJS from '../../assets/certificates/cert_nodejs.png';
...
const certificatesData: CertificateData[] = [
  ...
  },
  {
    ...
    year: '2026',
    link: 'https://static.mate.academy/certificates/production/844648/133031/e6eb17a3-10f8-43ae-957d-6ce3261eb4f2/marusina-certificate.pdf?_gl=1*5cnim9*_gcl_au*MTEzMDQwMDk2My4xNzc0Njk3NDg5LjIxMzI0OTg4NjIuMTc4MTYyMzI2NS4xNzgxNjIzMjY0',
    category: 'Mate Academy'
  },
  {
    image: certTS,
